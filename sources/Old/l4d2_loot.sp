...
public void OnPluginStart()
{
	...
	else
	{
		...
		NoFarmPanic = CreateConVar("l4d2_loot_nofarm_panic", "0", "Panic event on no-farm mode", FCVAR_NONE);
		BotsCanFarm = CreateConVar("l4d2_loot_botscanfarm", "6", "Bots can farm if players count <= X", FCVAR_NONE);
		CheckPrechachedModels = CreateConVar("l4d2_loot_checkprecache", "0", "", FCVAR_NONE);
		...
		l4d2_loot_h_drop_items = CreateConVar("l4d2_loot_h_drop_items", "1", "", FCVAR_NONE);
		l4d2_loot_b_drop_items = CreateConVar("l4d2_loot_b_drop_items", "1", "", FCVAR_NONE);
		l4d2_loot_s_drop_items = CreateConVar("l4d2_loot_s_drop_items", "1", "", FCVAR_NONE);
		l4d2_loot_c_drop_items = CreateConVar("l4d2_loot_c_drop_items", "1", "", FCVAR_NONE);
		l4d2_loot_sp_drop_items = CreateConVar("l4d2_loot_sp_drop_items", "1", "", FCVAR_NONE);
		l4d2_loot_j_drop_items = CreateConVar("l4d2_loot_j_drop_items", "1", "", FCVAR_NONE);
		l4d2_loot_t_drop_items = CreateConVar("l4d2_loot_t_drop_items", "1", "", FCVAR_NONE);

		l4d2_loot_h_chance_health = CreateConVar("l4d2_loot_h_chance_health", "16", "", FCVAR_NONE);
		l4d2_loot_h_chance_melee = CreateConVar("l4d2_loot_h_chance_melee", "12", "", FCVAR_NONE);
		l4d2_loot_h_chance_bullet = CreateConVar("l4d2_loot_h_chance_bullet", "15", "", FCVAR_NONE);
		l4d2_loot_h_chance_explosive = CreateConVar("l4d2_loot_h_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_h_chance_throw = CreateConVar("l4d2_loot_h_chance_throw", "20", "", FCVAR_NONE);
		l4d2_loot_h_chance_upgrades = CreateConVar("l4d2_loot_h_chance_upgrades", "10", "", FCVAR_NONE);
		l4d2_loot_h_chance_misc = CreateConVar("l4d2_loot_h_chance_misc", "10", "", FCVAR_NONE);
		l4d2_loot_h_chance_misc2 = CreateConVar("l4d2_loot_h_chance_misc2", "10", "", FCVAR_NONE);
		l4d2_loot_h_chance_nodrop = CreateConVar("l4d2_loot_h_chance_nodrop", "30", "", FCVAR_NONE);

		l4d2_loot_b_chance_health = CreateConVar("l4d2_loot_b_chance_health", "16", "", FCVAR_NONE);
		l4d2_loot_b_chance_melee = CreateConVar("l4d2_loot_b_chance_melee", "12", "", FCVAR_NONE);
		l4d2_loot_b_chance_bullet = CreateConVar("l4d2_loot_b_chance_bullet", "15", "", FCVAR_NONE);
		l4d2_loot_b_chance_explosive = CreateConVar("l4d2_loot_b_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_b_chance_throw = CreateConVar("l4d2_loot_b_chance_throw", "20", "", FCVAR_NONE);
		l4d2_loot_b_chance_upgrades = CreateConVar("l4d2_loot_b_chance_upgrades", "10", "", FCVAR_NONE);
		l4d2_loot_b_chance_misc = CreateConVar("l4d2_loot_b_chance_misc", "10", "", FCVAR_NONE);
		l4d2_loot_b_chance_misc2 = CreateConVar("l4d2_loot_b_chance_misc2", "10", "", FCVAR_NONE);
		l4d2_loot_b_chance_nodrop = CreateConVar("l4d2_loot_b_chance_nodrop", "30", "", FCVAR_NONE);

		l4d2_loot_s_chance_health = CreateConVar("l4d2_loot_s_chance_health", "16", "", FCVAR_NONE);
		l4d2_loot_s_chance_melee = CreateConVar("l4d2_loot_s_chance_melee", "12", "", FCVAR_NONE);
		l4d2_loot_s_chance_bullet = CreateConVar("l4d2_loot_s_chance_bullet", "15", "", FCVAR_NONE);
		l4d2_loot_s_chance_explosive = CreateConVar("l4d2_loot_s_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_s_chance_throw = CreateConVar("l4d2_loot_s_chance_throw", "20", "", FCVAR_NONE);
		l4d2_loot_s_chance_upgrades = CreateConVar("l4d2_loot_s_chance_upgrades", "10", "", FCVAR_NONE);
		l4d2_loot_s_chance_misc = CreateConVar("l4d2_loot_s_chance_misc", "10", "", FCVAR_NONE);
		l4d2_loot_s_chance_misc2 = CreateConVar("l4d2_loot_s_chance_misc2", "10", "", FCVAR_NONE);
		l4d2_loot_s_chance_nodrop = CreateConVar("l4d2_loot_s_chance_nodrop", "30", "", FCVAR_NONE);

		l4d2_loot_c_chance_health = CreateConVar("l4d2_loot_c_chance_health", "16", "", FCVAR_NONE);
		l4d2_loot_c_chance_melee = CreateConVar("l4d2_loot_c_chance_melee", "12", "", FCVAR_NONE);
		l4d2_loot_c_chance_bullet = CreateConVar("l4d2_loot_c_chance_bullet", "15", "", FCVAR_NONE);
		l4d2_loot_c_chance_explosive = CreateConVar("l4d2_loot_c_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_c_chance_throw = CreateConVar("l4d2_loot_c_chance_throw", "20", "", FCVAR_NONE);
		l4d2_loot_c_chance_upgrades = CreateConVar("l4d2_loot_c_chance_upgrades", "10", "", FCVAR_NONE);
		l4d2_loot_c_chance_misc = CreateConVar("l4d2_loot_c_chance_misc", "10", "", FCVAR_NONE);
		l4d2_loot_c_chance_misc2 = CreateConVar("l4d2_loot_c_chance_misc2", "10", "", FCVAR_NONE);
		l4d2_loot_c_chance_nodrop = CreateConVar("l4d2_loot_c_chance_nodrop", "30", "", FCVAR_NONE);

		l4d2_loot_sp_chance_health = CreateConVar("l4d2_loot_sp_chance_health", "16", "", FCVAR_NONE);
		l4d2_loot_sp_chance_melee = CreateConVar("l4d2_loot_sp_chance_melee", "12", "", FCVAR_NONE);
		l4d2_loot_sp_chance_bullet = CreateConVar("l4d2_loot_sp_chance_bullet", "15", "", FCVAR_NONE);
		l4d2_loot_sp_chance_explosive = CreateConVar("l4d2_loot_sp_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_sp_chance_throw = CreateConVar("l4d2_loot_sp_chance_throw", "20", "", FCVAR_NONE);
		l4d2_loot_sp_chance_upgrades = CreateConVar("l4d2_loot_sp_chance_upgrades", "10", "", FCVAR_NONE);
		l4d2_loot_sp_chance_misc = CreateConVar("l4d2_loot_sp_chance_misc", "10", "", FCVAR_NONE);
		l4d2_loot_sp_chance_misc2 = CreateConVar("l4d2_loot_sp_chance_misc2", "10", "", FCVAR_NONE);
		l4d2_loot_sp_chance_nodrop = CreateConVar("l4d2_loot_sp_chance_nodrop", "30", "", FCVAR_NONE);

		l4d2_loot_j_chance_health = CreateConVar("l4d2_loot_j_chance_health", "16", "", FCVAR_NONE);
		l4d2_loot_j_chance_melee = CreateConVar("l4d2_loot_j_chance_melee", "12", "", FCVAR_NONE);
		l4d2_loot_j_chance_bullet = CreateConVar("l4d2_loot_j_chance_bullet", "15", "", FCVAR_NONE);
		l4d2_loot_j_chance_explosive = CreateConVar("l4d2_loot_j_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_j_chance_throw = CreateConVar("l4d2_loot_j_chance_throw", "20", "", FCVAR_NONE);
		l4d2_loot_j_chance_upgrades = CreateConVar("l4d2_loot_j_chance_upgrades", "10", "", FCVAR_NONE);
		l4d2_loot_j_chance_misc = CreateConVar("l4d2_loot_j_chance_misc", "10", "", FCVAR_NONE);
		l4d2_loot_j_chance_misc2 = CreateConVar("l4d2_loot_j_chance_misc2", "10", "", FCVAR_NONE);
		l4d2_loot_j_chance_nodrop = CreateConVar("l4d2_loot_j_chance_nodrop", "30", "", FCVAR_NONE);

		l4d2_loot_t_chance_health = CreateConVar("l4d2_loot_t_chance_health", "15", "", FCVAR_NONE);
		l4d2_loot_t_chance_melee = CreateConVar("l4d2_loot_t_chance_melee", "2", "", FCVAR_NONE);
		l4d2_loot_t_chance_bullet = CreateConVar("l4d2_loot_t_chance_bullet", "3", "", FCVAR_NONE);
		l4d2_loot_t_chance_explosive = CreateConVar("l4d2_loot_t_chance_explosive", "1", "", FCVAR_NONE);
		l4d2_loot_t_chance_throw = CreateConVar("l4d2_loot_t_chance_throw", "4", "", FCVAR_NONE);
		l4d2_loot_t_chance_upgrades = CreateConVar("l4d2_loot_t_chance_upgrades", "6", "", FCVAR_NONE);
		l4d2_loot_t_chance_misc = CreateConVar("l4d2_loot_t_chance_misc", "1", "", FCVAR_NONE);
		l4d2_loot_t_chance_misc2 = CreateConVar("l4d2_loot_t_chance_misc2", "1", "", FCVAR_NONE);
		l4d2_loot_t_chance_nodrop = CreateConVar("l4d2_loot_t_chance_nodrop", "0", "", FCVAR_NONE);
		...
		l4d2_loot_grenade_launcher = CreateConVar("l4d2_loot_grenade_launcher", "100", "", FCVAR_NONE);
		...
		l4d2_loot_gnome = CreateConVar("l4d2_loot_gnome", "100", "", FCVAR_NONE);
...
#if DEBUG
	PrintToChatAll("\x05Event: \x03CheckPoint ( \x01%N :: %s :: %d \x03 )", Target, strBuffer, event.GetInt("area"));
#endif
...
//	PrintToChatAll("\x05Event: PlayerDeath (Start)");
	...
	if (GetEventBool(event, "attackerisbot") == true && GetConVarInt(BotsCanFarm) < GetRealClientCount(true))
	{
		return Plugin_Continue;
	}
...
//		return Plugin_Continue;
	...
	if (GetEventBool(event, "victimisbot") == false && GetConVarInt(DropItemsFromPlayers) == 0) return Plugin_Continue;
...
public int LootDropItem(any client, int ItemNumber)
{
...
bool IsModelPrecachedEx(const char[] ModelName)
{
