...
public void OnPluginStart()
{
	...
	g_hCooldownEnable	= CreateConVar("zcs_cooldown_enable", "1", "Enable infected class restriction timer after player death. (0=Disable timer)");
	...
	g_hSmokerLimit		= CreateConVar("zcs_smoker_limit", "4", "How many Smokers allowed. (-1=Use Server, 0=None Allowed, 1-10=Limit)", 0, true, -1.0, true, 10.0);
	g_hBoomerLimit		= CreateConVar("zcs_boomer_limit", "4", "How many Boomers allowed. (-1=Use Server, 0=None Allowed, 1-10=Limit)", 0, true, -1.0, true, 10.0);
	g_hHunterLimit		= CreateConVar("zcs_hunter_limit", "4", "How many Hunters allowed. (-1=Use Server, 0=None Allowed, 1-10=Limit)", 0, true, -1.0, true, 10.0);
	g_hSpitterLimit		= CreateConVar("zcs_spitter_limit", "4", "How many Spitters allowed. (-1=Use Server, 0=None Allowed, 1-10=Limit)", 0, true, -1.0, true, 10.0);
	g_hJockeyLimit		= CreateConVar("zcs_jockey_limit", "4", "How many Jockeys allowed. (-1=Use Server, 0=None Allowed, 1-10=Limit)", 0, true, -1.0, true, 10.0);
	g_hChargerLimit		= CreateConVar("zcs_charger_limit", "4", "How many Chargers allowed. (-1=Use Server, 0=None Allowed, 1-10=Limit)", 0, true, -1.0, true, 10.0);
...
public Action Event_GhostSpawnTime(Event event, const char[] name, bool dontBroadcast)
{
	...
	Sub_ClearClassLock(Client);
	float SpawnTime = event.GetFloat("spawntime");
...
public void Sub_DetermineClass(any Client, any ZClass)
{
	...
	if (Sub_IsPlayerGhost(Client))
	{
		...
		if (cAbility > 0)
		{
			AcceptEntityInput(cAbility, "Kill");
		}
