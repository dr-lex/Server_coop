...
public Action OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3])
{
	if (IsValidClient(victim) && GetClientTeam(victim) == 3 && !IsIncapped(victim))
	{
		...
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 1 && show_smoker.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 2 && show_boomer.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 3 && show_hunter.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 4 && show_spitter.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 5 && show_jockey.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 6 && show_charger.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
		if(GetEntProp(victim, Prop_Send, "m_zombieClass") == 8 && show_tank.IntValue == 1)
		{
			DisplayInstructorHint(victim, 0.0, 0.0, 0.0, true, false, "", "", "", false, {255, 255, 0}, Message);
		}
	}
...
public void eTankKilled(Event event, const char[] name, bool dontBroadcast)
{
	int tank = GetClientOfUserId(event.GetInt("userid"));
	if (IsValidClient(tank))
	{
